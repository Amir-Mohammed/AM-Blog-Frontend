    ...
    const fetchData = async () => {
      ...
      try {
        const { data } = await axios.get(
          `${process.env.REACT_APP_BACKEND_URI}/feeds/me?limit=${limit}&skip=${skip}`,
          {
            headers: {
        ...
        <div className="container-fluid">
          <div className="card">
            <div className="card-body">
              <p className="card-text">You have no feeds to be shown</p>
              <h2 className="card-text">
                {" "}
                Start following people to get some feeds
              </h2>
